...
const endpoint = process.env.my_TOKEN;
...
const CONTRACT_ADDRESS = "0x921541b56788Ea9deA1AD1d697672DaA6C359872";
const NFTABI = [
	{
		"anonymous": false,
		"inputs": [
	...
	},
	{
		"inputs": [
			{
				"internalType": "contract MegaBabies",
				"name": "tokToCP",
				"type": "address"
			}
		],
...
const ABI = [
	...
	},
	{
		...
		"name": "EvTokenRemovedFromAuction",
		"type": "event"
	},
	{
		"anonymous": false,
	...
	},
	{
		...
		"name": "removeMegaBabyFromAuction",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
	...
	},
	{
		...
		"name": "getEstimatedMegaForBnbPrice",
		"outputs": [
			{
				"internalType": "uint256[]",
				"name": "",
...
const STAKINGADDRESS = "0xDBB6729902AA6C9754A260D624D26716648aB476";
const STAKINGABI = [
    {
        "inputs": [
            {
...
bot.command(['emotion', 'emote', 'mb'], ctx => {
    console.log(ctx.update.message.text);
    var arr1 = ctx.update.message.text.split(' ');
    var num = parseInt(arr1[1])
    var number = 0;
...
bot.command(['nftstat', 'stats'], ctx => {
    ...
    https.get(url, async (res) => {
        ...
        res.on("end", async () => {
            try {
                var totalStaked = await NFTcontract.methods.balanceOf(STAKINGADDRESS).call();
...
function Connect(){
	...
	provider2 = new Web3.providers.HttpProvider(`wss://divine-small-field.bsc.quiknode.pro/${endpoint}/`);
                ...
                res.on("end", () => {
                    try {
                        ...
                        var myMessage = "<b>\u{1F4E2} Attention diamond handed Megafam!  </b>\n\n"
                            ...
                            myMessage += `<b>\u{1F3AB} ID: ${event.returnValues.id}   </b>\n`
